  ...
  return (
    <Section crosses id='how-to-use'>
      <div className="container">
        <Heading title='Genarative AI made for creators' text='Brainwave unlocks the potential of AI-powerd application'/>
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[45rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3"> Brainwave unlocks the potential of AI-powerd applications</p>
              <ul className="body-2">
